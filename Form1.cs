        ...
        public void SaveSelection(bool showCursor)
        {
            ...
            if (ScreenPath != "" || ScreenShot.saveToClipboard)
            {
                ...
                if (ScreenShot.saveToClipboard)
                {
                    ...
                    // MessageBox.Show("Capture area saved, click OK to begin!", "AutoClicker v0.0.1", MessageBoxButtons.OK);
                ...
                else
                {
                    ...
                    MessageBox.Show("Area saved to file", "AutoClicker v0.0.1", MessageBoxButtons.OK);
            ...
            else
            {
                ...
                MessageBox.Show("File save cancelled", "AutoClicker v0.0.1", MessageBoxButtons.OK);
                this.InstanceRef.Show();
                this.Close();
